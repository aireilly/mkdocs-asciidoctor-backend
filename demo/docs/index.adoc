...
This is a demo site with lots of meaningless text.

== Intro

A link to <<anchors,anchors>> and xref:page-2.adoc#other-section[other page].

include::snippets/_snippet.adoc[]

include::modules/module.adoc[leveloffset=+1]

include::modules/procedure.adoc[leveloffset=+2]

== anchors

[[explicit-id]]Heading with explicit id
...
ui:
  bundle:
    url: {url-project}/releases/download/{current-release}/ui-bundle.zip # <1>
  calling-birds:
   - huey
   - dewey
   - louie
